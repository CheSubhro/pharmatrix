...
export default function PurchaseDetailsPage() {
  ...
  const fetchData = async () => {
    try {
      ...
      const [purchaseResponse, rackResponse] =
        await Promise.all([
            ...
            <div className="flex gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-green-700">
                  This purchase has been received successfully.
                  The purchased quantities have been added to
                  stock and stock movements have been recorded.
                </p>
              </div>
            </div>
          </div>
